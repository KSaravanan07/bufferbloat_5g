...
//     }
  ...
  Config::SetDefault ("ns3::CoDelQueueDisc::MaxSize",QueueSizeValue (QueueSize (QueueSizeUnit::PACKETS, 1000)));
  ...
  qdiscs = tchBottleneck.Install (internetDevices);
  ...
  // Config::SetDefault ("ns3::CoDelQueueDisc::MaxSize", StringValue (std::to_string(1000) + "p"));
