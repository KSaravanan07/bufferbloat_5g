...
private:
  ...
  void DoTransmitPdcpPduDynamic(Ptr<Packet> p);
  void DynamicRLCQueueLimit(int64_t bytes_transmitted);
...
private:
  ...
  int64_t m_dequed_bytes;
  int64_t  m_last_time;
  int64_t  m_min_increase;
  int64_t m_limit;
  bool has_packet_dropped;
};
